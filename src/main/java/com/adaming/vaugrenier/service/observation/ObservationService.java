...
public interface ObservationService {
    ...
    void createObservation(String genre,String species,String vulgarName,String description,String imageUrl,List<Dates> dates);
    ...
    void createDates(String day, String month, String year);
}
